...
namespace Shared.Components.DiagramBoard.DiagramCanvas
{
    public partial class DiagramNodeView
    {
        ...
        [Parameter]
        public EventCallback<DiagramNode> OnAddSubReportItemClicked { get; set; }
        ...
        string subReportIcon = @"<svg xmlns=""http://www.w3.org/2000/svg"" viewBox=""0 0 32 32"" xml:space=""preserve""><path d=""M19 3v6h6zH7v26h18V9m-11 4h7m-7 4h7m-7 4h7"" style=""fill:none;stroke:#000;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10""/></svg>";
        ...
        private async Task OnSubReportItemClicked()
        {
            if (!IsSelected) return;
            await OnAddSubReportItemClicked.InvokeAsync(Node);
        }
    }
}
